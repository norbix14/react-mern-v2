...
import { isAnyEmptyValue, axiosRequest, isValidEmail } from '../helpers'
  ...
  return (
    <>
      ...
      >
        ...
        />
        <InputSubmit value="send instructions" disabled={btnDisabled} />
        {instructionSend && <AlertMessage alert={instructionData} />}
        {fieldError && (
          <AlertMessage alert={{ error: true, message: confirmationMessage }} />
        )}
      </form>
